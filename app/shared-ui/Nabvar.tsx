...
import ThemeMode from "@/app/shared-ui/ThemeMode";
...
// ListItem component with forwardRef and types
    ...
    <li>
      <NavigationMenuLink asChild>
        <a
          ...
          {...props}
        >
          <div className="text-lg font-medium leading-none dark:text-zinc-100">{title}</div>
          <p className="line-clamp-2 text-lg leading-snug text-muted-foreground dark:text-zinc-100">
            {children}
          </p>
        </a>
      </NavigationMenuLink>
  ...
  return (
    <NavigationMenu>
      <NavigationMenuList className="gap-15 2xl:gap-x-8 justify-center">
        <NavigationMenuItem>
          <NavigationMenuTrigger className="dark:text-zinc-100 font-medium text-lg">
            Portafolio
          </NavigationMenuTrigger>
          <NavigationMenuContent className="dark:text-zinc-100">
  ...
  return (
    <nav className="flex py-4 w-full justify-between items-center">
        ...
        <Link href="/">
          {isDarkMode ? (
            <div className="cursor-pointer">
              <Image src={MyDarkImage} alt="My image" width={50} height={50} />
            </div>
          ) : (
            <div className="cursor-pointer">
              <Image src={MyLightImage} alt="My image" width={50} height={50} />
            </div>
          )}
        </Link>
      </div>
      ...
      <section className="flex w-1/4 items-center justify-end  gap-4">
        <Link href="/login" className="dark:text-zinc-100 border rounded-lg text-sm p-2 hover:bg-zinc-100 bg-primary text-zinc-50 dark:hover:bg-stone-600 hover:text-black">
          Iniciar sesión
        </Link>
        ...
        <Drawer>
          ...
          >
            ...
            <DrawerDescription className="flex flex-col gap-2 pl-4 w-full">
              <NavigationMenuLink href="/" className="rounded-sm px-2 py-2 text-lg hover:bg-zinc-100 w-full text-left">
                Inicio
              </NavigationMenuLink>
              <NavigationMenuLink href="/web-dev" className="rounded-sm px-2 py-2 text-lg hover:bg-zinc-100 w-full text-left">
                Web Development
              </NavigationMenuLink>
              <NavigationMenuLink href="/app-dev" className="rounded-sm px-2 py-2 text-lg hover:bg-zinc-100 w-full text-left">
                App Development
              </NavigationMenuLink>
              <NavigationMenuLink href="/custom-soft" className="rounded-sm px-2 py-2 text-lg hover:bg-zinc-100 w-full text-left">
                Custom Software
              </NavigationMenuLink>
              <NavigationMenuLink href="/about" className="rounded-sm px-2 py-2 text-lg hover:bg-zinc-100 w-full text-left">
                About
              </NavigationMenuLink>
              <NavigationMenuLink href="/contact" className="rounded-sm px-2 py-2 text-lg hover:bg-zinc-100 w-full text-left">
                Contact
              </NavigationMenuLink>
            </DrawerDescription>
          </DrawerContent>
